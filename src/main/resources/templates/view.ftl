...
<header>
  ...
  <div class="logo">
    ...
    <div class="logo_r f_r"><a href="/"><img src="../static/images/search.png"></a></div>
  </div>
  <nav id="topnav">
    <ul>
      <a href="index.html" target="_blank">网站首页</a> <a href="news.html" target="_blank">新闻中心</a> <a href="p.html" target="_blank">产品中心</a> <a href="a.html" target="_blank">关于我们</a> <a href="c.html" target="_blank">联系我们</a> <a href="b.html" target="_blank">网上留言</a>
    </ul>
...
myFocus.set({
	...
	pattern:'mF_kdui'//风格
      ...
      <div id="myFocus"><!--焦点图盒子-->
        ...
        <div class="pic"><!--图片列表-->
          <ul>
            <li><a href="#1"><img src="../static/images/1m.jpg" thumb="" alt="酷站代码整理" text="图片1更详细的描述文字" /></a></li>
            <li><a href="#2"><img src="../static/images/2m.jpg" thumb="" alt="酷站代码特效大全" text="图片2更详细的描述文字" /></a></li>
            <li><a href="#3"><img src="../static/images/3m.jpg" thumb="" alt="酷站代码特效" text="图片3更详细的描述文字" /></a></li>
            <li><a href="#4"><img src="../static/images/4m.jpg" thumb="" alt="酷站代码素材" text="图片4更详细的描述文字" /></a></li>
            <li><a href="#5"><img src="../static/images/5m.jpg" thumb="" alt="酷站代码教程" text="图片5更详细的描述文字" /></a></li>
          </ul>
        </div>
      </div>
    ...
    <div class="ad" id="r_ad"> <img src="../static/images/03.jpg"> </div>
    <script type="text/javascript">
jQuery.noConflict();
jQuery(function() { 
    var elm = jQuery('#r_ad'); 
...
<footer>
  <div class="endfoot">
    <div class="ft-info f_l">
      <div class="ftlogo"><a href="#" target="_blank"><img src="../static/images/ftlogo.png"></a></div>
      <div class="ft-title">
